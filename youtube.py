...
#the loop function for gettig specific need of the playlists
...
def get_channel_videos(channel_id):
 ...
 #the loop function for gettig specific need of  videos id in all pages . 
...
def get_video_info(video_ids):
    ...
    #the loop function for gettig specific need of videos     
...
#the loop function for gettig specific need of comments                        
...
client = pymongo.MongoClient("mongodb+srv://<username>:<password>@cluster0.dgp142f.mongodb.net/?retryWrites=true&w=majority")
...
def playlists_table():
 ...
 #inserting values in playlist table
...
#inserting values in videos table
...
#inserting values in comments table
...
#select question at streemlight
